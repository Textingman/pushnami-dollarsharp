    ...
    <footer className="text-white py-12" style={{ backgroundColor: '#064E3B' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Dollarsharp</h3>
            <p style={{ color: '#A7F3D0' }}>
              Sharpen your money skills, one lesson at a time.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#A7F3D0' }} className="hover:text-white">Start Learning</Link></li>
            </ul>
          </div>
          <div>
